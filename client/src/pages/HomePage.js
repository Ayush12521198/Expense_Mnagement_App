...
return (
  <Layout >
    {loading && <Spinner />}
    <div className="filters" style={{ backgroundColor: 'rgba(128, 128, 128, 0.2)', backdropFilter: 'blur(10px)', padding: '10px', borderRadius: '5px' }}>
      <div>
        <h6>Select Frequency</h6>
        <Select value={frequency} onChange={(values) => setFrequency(values)} style={{ width: 150, color: 'blue' }}>
      ...
      <div className="switch-icons" style={{ backgroundColor: '#0d6efd' }}>
        <UnorderedListOutlined
          className={`mx-2 ${
  ...
  style={{ color: '#000000' }} // Set color to dark black
